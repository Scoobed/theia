...
require (
	antrea.io/antrea v0.0.0-20250103000000-bf190e0f6000
...
require (
	...
	sigs.k8s.io/knftables v0.0.19-0.20250918210213-152a9262585d // indirect
...
require (
	antrea.io/libOpenflow v0.17.0 // indirect
	antrea.io/ofnet v0.15.0 // indirect
...
// Use local Antrea with K8s 0.34 support
replace antrea.io/antrea => /home/epay0/workspace/antrea
